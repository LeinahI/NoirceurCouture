        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h2 class="text-white">Preparing Orders
                        ...
                        <a href="ordersPreparing.php" class="btn btn-light float-end ms-2"><span class="text-primary">View Preparing Orders</span></a>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover table-striped" id="ordTable">
                        ...
                        <tbody>
                            <?php
                            $orders = getAllPreparingOrdersbyStore($_SESSION['auth_user']['user_ID']);
