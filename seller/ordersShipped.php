            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <h2 class="text-white">Shipped Out Orders
                        ...
                        <a href="ordersShipped.php" class="btn btn-light float-end ms-2"><span class="text-primary">View Shipped Out</span></a>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover table-striped" id="ordTable">
                        ...
                        <tbody>
                            <?php
                            $orders = getAllShippedOutOrdersbyStore($_SESSION['auth_user']['user_ID']);
