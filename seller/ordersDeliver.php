        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h2 class="text-white">Delivered Orders
                        <a href="ordersCancelled.php" class="btn btn-light float-end ms-2">View Cancelled</a>
                        <a href="ordersDeliver.php" class="btn btn-light float-end ms-2"><span class="text-primary">View Delivered</span></a>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-hover table-striped" id="ordTable">
                        ...
                        <tbody>
                            <?php
                            $orders = getAllDeliveredOrdersbyStore($_SESSION['auth_user']['user_ID']);
