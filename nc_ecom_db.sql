...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2024 at 12:29 PM
...
(17, 'nrcrCtr3201865798565', 2, 'Ana Bien Beatriz Salazar', 'ana@gmail.com', '09865798565', 'Tolentino, E Rd, Tagaytay, Cavite', '4120', 10019.10, 'Cash on Delivery', 2147483647, 3, NULL, '2023-12-04 06:48:28');
...
(34, 17, 26, 1, 10019.10, '2023-12-04 06:48:28');
...
--
ALTER TABLE `likes`
  MODIFY `likes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `order_items`
  MODIFY `orderItems_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
