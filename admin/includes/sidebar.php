...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="_blank">
            <img src="../images/logo/NoirceurCouture_WT.png" class="navbar-brand-img h-100" alt="LOGO">
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= $page == "category.php" ? 'active bg-gradient-primary' : '' ?>" href="category.php">
                    ...
                    <span class="nav-link-text ms-1">All Brand Categories</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white <?= $page == "addCategory.php" ? 'active bg-gradient-primary' : '' ?>" href="addCategory.php">
                    ...
                    <span class="nav-link-text ms-1">Add Brand Category</span>
                </a>
            </li>
            <li class="nav-item">
