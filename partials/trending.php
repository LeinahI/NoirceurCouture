...
<div class="mt-3">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="my-4 <?= basename($_SERVER['PHP_SELF']) === 'productView.php' ? 'text-start' : 'text-center'; ?>">Trending Products</h4>
                <div class="row">
                    <div class="owl-one ">
                                        ...
                                        <a href="productView.php?product=<?= $item['product_slug'] ?>" class="card-link">
                                            <div class="card border-0">
                                                <div class="card-body d-flex flex-column justify-content-between bg-tertiary rounded">
                                                    <div>
                                                        <img class="mb-2 " src="../assets/uploads/products/<?= $item['product_image'] ?>" alt="Product Image">
