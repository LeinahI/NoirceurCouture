                        ...
                        <form action="../models/profileUpdate.php" method="POST">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <?php if (isset($_GET['initv']) && !empty($_GET['initv'])) {
                                        $activation_code = $_GET['initv'];
                                    ...
                                    ?>
                                            <input type="hidden" name="initv" value="<?= $activation_code ?>">
                                            ...
                                            <div class="text-center">
                                                <p>We have sent the One-Time Password to your email as <br>
                                                    <b><?= $_SESSION['initialVerification'] ?></b>.
                                                </p>
                                                <?php
                                                if (isset($_SESSION['oldEmail'])) {
                                                ?>
                                                    <p class="text-accent"><?= $_SESSION['oldEmail'] ?></p>
                                                <?php
                                                }
                                                ?>
                                            </div>
